...
P1=load('Z:\data_2photon\matlab_2ndLev\NEW_DECODING\AN\thr5\P1-P2_AN1-16CELLSEL_DECSCR_CRSCON_SMLR_L2_ctm0.60.mat')
P2=load('Z:\data_2photon\matlab_2ndLev\NEW_DECODING\AN\thr5\P2-P1_AN1-16CELLSEL_DECSCR_CRSCON_SMLR_L2_ctm0.60.mat')
P3=load('Z:\data_2photon\matlab_2ndLev\NEW_DECODING\AN\thr5\P1-P2_AN17-22CELLSEL_DECSCR_CRSCON_SMLR_L2_ctm0.60.mat')
P4=load('Z:\data_2photon\matlab_2ndLev\NEW_DECODING\AN\thr5\P2-P1_AN17-22CELLSEL_DECSCR_CRSCON_SMLR_L2_ctm0.60.mat')


clear DEC
ses= [(1:8) 15 16]%   [(1:8)   (17:22)]%
icomp=6
for icont1 = [1 :3]
    for icont2 = [1 :3]
        for i0= 1:length(ses)
...
% [a b]=ttest((DEC(:,1,1)-DEC(:,1,3))./DEC(:,1,1))
% 
% [a b]=ttest((DEC(:,3,3)-DEC(:,3,1))./DEC(:,3,3))
[DEC(:,3,3) DEC(:,3,1)]
...
p = signrank(x,y)
ALL=[ALL; [x(:)  y(:)]];
figure; plot(ALL(:,1), ALL(:,2),'.'); hold on; plot([min(ALL(:)) max(ALL(:))],[min(ALL(:)) max(ALL(:))],'k')
...
%% for awake data
C1=load('Z:\data_2photon\matlab_2ndLev\NEW_DECODING\AWAKE\thr5\P2-P1_AW23-40CELLSEL_NCELL_CRSCON_SMLR_L2_ctm0.60.mat')
C2=load('Z:\data_2photon\matlab_2ndLev\NEW_DECODING\AWAKE\thr5\P1-P2_AW23-40CELLSEL_NCELL_CRSCON_SMLR_L2_ctm0.60.mat')
icomp=2
aa=[];
lst = [25 29 30 32 33 40];
for ii0= 1:length(lst)
    ii = lst(ii0);
    a=0.5*(C1.DEC_SELCELL{icomp, ii}+C2.DEC_SELCELL{icomp, ii});
    aa(ii0,:,:)=squeeze(a(1,:,:));
