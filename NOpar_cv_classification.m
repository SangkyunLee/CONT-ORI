function [out, opts] = NOpar_cv_classification(dataset,label, opts)
% NOpar_cv_classification(dataset,label, opts)
% This function is identical to  par_cv_classification without parfor
% 
% INPUT:
