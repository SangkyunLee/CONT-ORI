function [pixel_list,boundary,boundary_list]=disk_roi(map,center,cell_radius)
...
boundary(1,:)=(x+(rin/nsample*full_radius).*cos(t));
boundary(2,:)=(y+(rin/nsample*full_radius).*sin(t));
